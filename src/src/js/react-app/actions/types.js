...
//views
export const VIEWS_TOGGLE = 'views_toggle';
...
//map tiles
export const MAP_TILES = 'map_tiles';

//focus on current location
export const FOCUS_LOCATION = 'focus_location';

//focus loading
export const INTERNAL_LOAD = 'internal_load';
export const INITIAL_LOAD = 'initial_load';

//show single
export const SHOW_SINGLE = 'show_single';
export const SHOW_SINGLE_SLUG = 'show_single_slug';

//backupDb
export const BACKUP_DB = 'backup_db';
export const BACKUP_DB_ERROR = 'backup_db_error';
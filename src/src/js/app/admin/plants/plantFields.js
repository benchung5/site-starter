...
{name: 'trees_category_id', label: 'category', type: 'multiSelect', error: 'Please enter a category', condition: 'required'},
    ...
    {name: 'moisture', label: 'moisture', type: 'multiSelect', error: null, condition: null},
    {name: 'parts_used', label: 'parts used', type: 'multiSelect', error: null, condition: null},
    {name: 'preparations', label: 'preparations', type: 'multiSelect', error: null, condition: null},
    {name: 'organs_and_tissue', label: 'organs and tissue', type: 'multiSelect', error: null, condition: null},
    ...
    {name: 'growing_instructions', label: 'growing instructions', type: 'textarea', error: null, condition: null},
    ...
    {name: 'folk_use', label: 'folk use', type: 'textarea', error: null, condition: null},
    {name: 'chinese_medicine', label: 'chinese medicine', type: 'textarea', error: null, condition: null},
    {name: 'special_chemistry', label: 'special chemistry', type: 'textarea', error: null, condition: null},
    {name: 'signature', label: 'signature', type: 'textarea', error: null, condition: null},
    {name: 'combinations', label: 'combinations', type: 'textarea', error: null, condition: null},
    {name: 'precautions', label: 'precautions', type: 'textarea', error: null, condition: null},

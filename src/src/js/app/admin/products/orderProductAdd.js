...
import { fetchOrderProductTables, addOrderProduct } from '../../actions/orderProducts';
...
var OrderProductAdd = {
	submitForm: function(e) {
		...
		if(hasErrors) {
			...
			addOrderProduct(formData, this.renderUpdated.bind(this));

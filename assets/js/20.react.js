...
/***/ "./src/js/react-app/components/admin/protected_warning.js":
/*!****************************************************************!*\
  !*** ./src/js/react-app/components/admin/protected_warning.js ***!
  \****************************************************************/
...
function (_Component) {
  ...
  function ProtectedWarning() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ProtectedWarning).apply(this, arguments));
  }
  ...
  _createClass(ProtectedWarning, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Please sign up or ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Link"], {
        className: "",
        to: "/".concat(_config_js__WEBPACK_IMPORTED_MODULE_2__["globals"].ADMIN_URL, "/signin")
      }, "login"), "."))));
    }
  }]);
...
//# sourceMappingURL=20.react.js.map
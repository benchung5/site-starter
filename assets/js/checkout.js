...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../component */ \"./src/js/app/component.js\");\n/* harmony import */ var _parts_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../parts/loader */ \"./src/js/app/parts/loader.js\");\n/* harmony import */ var _lib_cartUtils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../lib/cartUtils */ \"./src/js/app/lib/cartUtils.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\nvar PaymentStatus = {\n  paymentMessage: function () {\n    var _paymentMessage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n      var messageEl, _yield$this$stripe$re, paymentIntent, amount;\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              messageEl = null;\n              _context.next = 3;\n              return this.stripe.retrievePaymentIntent(this.clientSecret);\n            case 3:\n              _yield$this$stripe$re = _context.sent;\n              paymentIntent = _yield$this$stripe$re.paymentIntent;\n              _context.t0 = paymentIntent.status;\n              _context.next = _context.t0 === \"succeeded\" ? 8 : _context.t0 === \"processing\" ? 11 : _context.t0 === \"requires_payment_method\" ? 13 : 15;\n              break;\n            case 8:\n              amount = Object(_lib_cartUtils__WEBPACK_IMPORTED_MODULE_2__[\"formatPrice\"])(paymentIntent.amount);\n              messageEl = this.createEl(\"\\n\\t\\t\\t\\t<div id=\\\"payment-status-message\\\">\\t\\t    \\n\\t\\t\\t\\t\\t<p>\\n\\t\\t\\t\\t\\t\\t<b>We appreciate your business!</b><br>\\n\\t\\t\\t\\t\\t\\tA confirmation will be sent to your email address.<br>\\n\\t\\t\\t\\t\\t\\t*If you don't receive one, please check your junkmail inbox.<br>\\n\\t\\t\\t\\t\\t</p>\\n\\t\\t\\t\\t\\t<p>\\n\\t\\t\\t\\t\\t\\t<b>Package will be shipped to:</b><br>\\n\\t\\t\\t\\t\\t\\t<span id=\\\"customer-name\\\">\".concat(paymentIntent.shipping.name, \"</span><br>\\n\\t\\t\\t\\t\\t\\t<span id=\\\"line1\\\">\").concat(paymentIntent.shipping.address.line1, \"</span><br>\\n\\t\\t\\t\\t\\t\\t\").concat(paymentIntent.shipping.address.line2 ? '<span id=\"line2\">' + paymentIntent.shipping.address.line2 + '</span><br>' : '', \"\\n\\t\\t\\t\\t\\t\\t<span id=\\\"city\\\">\").concat(paymentIntent.shipping.address.city, \"</span>, <span id=\\\"state\\\">\").concat(paymentIntent.shipping.address.state, \"</span><br>\\n\\t\\t\\t\\t\\t\\t<span id=\\\"postal_code\\\">\").concat(paymentIntent.shipping.address.postal_code, \"</span><br>\\n\\t\\t\\t\\t\\t</p>\\n\\t\\t\\t\\t\\t<p>\\n\\t\\t\\t\\t\\t\\t<b>Details</b><br>\\n\\t\\t\\t\\t\\t\\tID: \").concat(paymentIntent.id, \"<br>\\n\\t\\t\\t\\t\\t\\tAmount: \").concat(amount, \" CAD\\n\\t\\t\\t\\t\\t</p>\\n\\t\\t\\t\\t\\t<p>\\n\\t\\t\\t\\t\\tIf you have any questions, please email us: <a href=\\\"mailto:info@naturewithus.com\\\">info@naturewithus.com</a>\\n\\t\\t\\t\\t\\t</p>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\"));\n              return _context.abrupt(\"break\", 17);\n            case 11:\n              messageEl = this.createEl(\"<p>Your payment is processing.</p>\");\n              return _context.abrupt(\"break\", 17);\n            case 13:\n              messageEl = this.createEl(\"Your payment was not successful, please try again.\");\n              return _context.abrupt(\"break\", 17);\n            case 15:\n              messageEl = this.createEl(\"Something went wrong.\");\n              return _context.abrupt(\"break\", 17);\n            case 17:\n              this.el.appendChild(messageEl);\n              this.loader.isLoading(false);\n            case 19:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee, this);\n    }));\n    function paymentMessage() {\n      return _paymentMessage.apply(this, arguments);\n    }\n    return paymentMessage;\n  }(),\n  init: function init(options) {\n    var proto = Object.assign({}, this, _component__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n    var inst = Object.create(proto);\n    // assign the instance constructor to the prototype so 'this' refers to the instance\n    proto.constructor = inst;\n\n    //call initialize on Component first\n    inst.initialize({\n      el: \"<div></div>\"\n    });\n    inst.container = document.querySelector('#message-container');\n    inst.loader = _parts_loader__WEBPACK_IMPORTED_MODULE_1__[\"default\"].init({\n      children: inst.el,\n      minHeight: '10rem',\n      size: '4rem',\n      backgroundColor: '#f4f6f7',\n      isInitialPageLoad: true\n    });\n    inst.container.appendChild(inst.loader.el);\n    inst.stripe = options.stripe ? options.stripe : null;\n    inst.message = options.message ? options.message : null;\n    inst.clientSecret = options.clientSecret ? options.clientSecret : null;\n    inst.paymentMessage();\n    return inst;\n  }\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (PaymentStatus);\n\n//# sourceURL=webpack:///./src/js/app/checkout/paymentStatus.js?");
...
eval("module.exports = __webpack_require__(/*! C:\\xampp\\xampp\\htdocs\\1pix_app\\src\\src\\js\\app\\checkout\\checkout.js */\"./src/js/app/checkout/checkout.js\");\n\n\n//# sourceURL=webpack:///multi_./src/js/app/checkout/checkout.js?");

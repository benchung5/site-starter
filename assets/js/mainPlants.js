...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../component */ \"./src/js/app/component.js\");\n/* harmony import */ var _search__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./search */ \"./src/js/app/parts/search.js\");\n/* harmony import */ var _sideMenuHeader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sideMenuHeader */ \"./src/js/app/parts/sideMenuHeader.js\");\n/* harmony import */ var _filter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filter */ \"./src/js/app/parts/filter.js\");\n\r\n\r\n\r\n\r\n\r\nvar SideMenuContent = {\r\n\tinit: function(options) {\r\n\t\tvar proto = Object.assign({}, this, _component__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\r\n\t\tvar inst = Object.create(proto);\r\n\t\t// assign the instance constructor to the prototype so 'this' refers to the instance\r\n\t\tproto.constructor = inst;\r\n\r\n\t\t//call initialize on Component first\r\n\t\tinst.initialize({\r\n\t\t\tel: \r\n\t\t\t`\r\n\t\t\t<div>\r\n\t\t\t <div id=\"side-menu-header\"></div>\r\n\t\t\t <div id=\"filter\"></div>\r\n             <div class=\"bottom\"></div>\r\n            </div>\r\n             `\r\n\t\t});\r\n\r\n\t\t//side menu header\r\n\t\tconst search = _search__WEBPACK_IMPORTED_MODULE_1__[\"default\"].init({\r\n\t\t\tplaceholder: 'Search Tree Name',\r\n\t\t\thasButton: true,\r\n\t\t\tonUpdate: options.onUpdate,\r\n\t\t\tfilterStore: options.filterStore,\r\n\t\t});\r\n\t\tconst sideMenuHeader = _sideMenuHeader__WEBPACK_IMPORTED_MODULE_2__[\"default\"].init({\r\n\t\t\tisClose: true,\r\n\t\t\tchildren: search.el,\r\n\t\t\tonUpdate: options.onUpdate,\r\n\t\t\tfilterStore: options.filterStore,\r\n\t\t\tonUpdate: options.onUpdate,\r\n\t\t});\r\n\t\tinst.el.querySelector('#side-menu-header').appendChild(sideMenuHeader.el);\r\n\r\n\t\t//filter\r\n\t\tconst filter = _filter__WEBPACK_IMPORTED_MODULE_3__[\"default\"].init({\r\n\t\t\tbuttonHeight: 40,\r\n\t\t\tcategories: options.categories,\r\n\t\t\tonUpdate: options.onUpdate,\r\n\t\t\tfilterStore: options.filterStore,\r\n\t\t});\r\n\t\tconst filterEl = inst.el.querySelector('#filter');\r\n\t\tfilterEl.appendChild(filter.el);\r\n\r\n\t\treturn inst;\r\n\t}\r\n}\r\n\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (SideMenuContent);\n\n//# sourceURL=webpack:///./src/js/app/parts/sideMenuContent.js?");

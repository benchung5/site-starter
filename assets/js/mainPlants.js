...
/***/ "./src/js/app/searchPlants/filterPlants.js":
/*!*************************************************!*\
  !*** ./src/js/app/searchPlants/filterPlants.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../component */ \"./src/js/app/component.js\");\n/* harmony import */ var _parts_sideMenuMobile__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../parts/sideMenuMobile */ \"./src/js/app/parts/sideMenuMobile.js\");\n/* harmony import */ var _gridViewPlants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gridViewPlants */ \"./src/js/app/searchPlants/gridViewPlants.js\");\n/* harmony import */ var _parts_sideMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../parts/sideMenu */ \"./src/js/app/parts/sideMenu.js\");\n/* harmony import */ var _filterPlants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./filterPlants */ \"./src/js/app/searchPlants/filterPlants.js\");\n/* harmony import */ var _storage_plantTablesStore__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../storage/plantTablesStore */ \"./src/js/app/storage/plantTablesStore.js\");\n/* harmony import */ var _storage_plantListStore__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../storage/plantListStore */ \"./src/js/app/storage/plantListStore.js\");\n/* harmony import */ var _storage_plantFilterStore__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../storage/plantFilterStore */ \"./src/js/app/storage/plantFilterStore.js\");\n/* harmony import */ var _storage_appStateStore__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../storage/appStateStore */ \"./src/js/app/storage/appStateStore.js\");\n/* harmony import */ var _parts_buttonShowMenu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../parts/buttonShowMenu */ \"./src/js/app/parts/buttonShowMenu.js\");\n/* harmony import */ var _actions_plants__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../actions/plants */ \"./src/js/app/actions/plants.js\");\n\n\n\n\n\n\n\n\n\n\n\n(function () {\n  var Main = {\n    onUpdate: function onUpdate(filterData) {\n      if (this.gridViewPlants && this.gridViewPlants.loader) {\n        this.gridViewPlants.loader.isLoading(true);\n      }\n      //search trees\n      Object(_actions_plants__WEBPACK_IMPORTED_MODULE_10__[\"searchTrees\"])(filterData || _storage_plantFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"].storageData, function (apiData) {\n        _storage_plantListStore__WEBPACK_IMPORTED_MODULE_6__[\"default\"].setData(apiData);\n      });\n    },\n    init: function init() {\n      var proto = Object.assign({}, this, _component__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n      var inst = Object.create(proto);\n      // assign the instance constructor to the prototype so 'this' refers to the instance\n      proto.constructor = inst;\n\n      //init storage\n      _storage_appStateStore__WEBPACK_IMPORTED_MODULE_8__[\"default\"].init();\n      _storage_plantListStore__WEBPACK_IMPORTED_MODULE_6__[\"default\"].init();\n      _storage_plantTablesStore__WEBPACK_IMPORTED_MODULE_5__[\"default\"].init();\n      _storage_plantFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"].init();\n      //only return plants in production mode for searchPlants\n      _storage_plantFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"].setData({\n        mode: 2\n      });\n      var appContainer = document.querySelector('.plant-search-container');\n      var pagePlaceholder = document.createElement('div');\n      pagePlaceholder.className = 'page-loading-placeholder page-loading-placeholder--plants';\n      pagePlaceholder.innerHTML = \"\\n\\t      \\t\\t<div class=\\\"row grid-view-inner\\\">\\n\\t      \\t\\t\\t<div class=\\\"left\\\"></div>\\n\\t      \\t\\t\\t<div class=\\\"right\\\">\\n\\t      \\t\\t\\t\\t<div class=\\\"cards-container page-placeholder-grid\\\">\\n\\t      \\t\\t\\t\\t\\t\".concat(Array.from({\n        length: 8\n      }).map(function () {\n        return \"\\n\\t      \\t\\t\\t\\t\\t\\t<div class=\\\"product-card placeholder-card\\\">\\n\\t      \\t\\t\\t\\t\\t\\t\\t<div class=\\\"inner\\\">\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"image\\\">\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"placeholder-image skeleton\\\"></div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"info\\\">\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"placeholder-line skeleton\\\"></div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"placeholder-line short skeleton\\\"></div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t\\t\\t\";\n      }).join(''), \"\\n\\t      \\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t</div>\\n\\t      \\t\\t</div>\\n\\t      \\t\");\n      if (appContainer) {\n        appContainer.appendChild(pagePlaceholder);\n      }\n\n      //get the filter settings from the url\n      Object(_actions_plants__WEBPACK_IMPORTED_MODULE_10__[\"updateFilterFromUrl\"])(function () {\n        //call initialize on Component first\n        inst.initialize({\n          container: document.querySelector('.plant-search-container'),\n          el: \"<div class=\\\"main-container\\\"}>\\n      \\t\\t          <div class=\\\"row\\\">\\n      \\t\\t           <div class=\\\"filter-container\\\">\\n      \\t\\t           </div>\\n      \\t\\t          </div>\\n      \\t\\t        </div>\"\n        });\n        if (pagePlaceholder && pagePlaceholder.parentNode) {\n          pagePlaceholder.parentNode.removeChild(pagePlaceholder);\n        }\n        var title = 'Search Northern Medicinal Plants';\n        var sideMenuMobile = _parts_sideMenuMobile__WEBPACK_IMPORTED_MODULE_1__[\"default\"].init({\n          title: title,\n          onUpdate: inst.onUpdate.bind(inst),\n          filterStore: _storage_plantFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"],\n          tablesStore: _storage_plantTablesStore__WEBPACK_IMPORTED_MODULE_5__[\"default\"].storageData,\n          filterComponent: _filterPlants__WEBPACK_IMPORTED_MODULE_4__[\"default\"]\n        });\n        inst.el.appendChild(sideMenuMobile.el);\n        var gridViewPlants = _gridViewPlants__WEBPACK_IMPORTED_MODULE_2__[\"default\"].init({\n          filterStore: _storage_plantFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"],\n          listStore: _storage_plantListStore__WEBPACK_IMPORTED_MODULE_6__[\"default\"],\n          onUpdate: inst.onUpdate.bind(inst),\n          tablesStore: _storage_plantTablesStore__WEBPACK_IMPORTED_MODULE_5__[\"default\"].storageData\n        });\n        inst.el.appendChild(gridViewPlants.el);\n        inst.gridViewPlants = gridViewPlants;\n        var sideMenu = _parts_sideMenu__WEBPACK_IMPORTED_MODULE_3__[\"default\"].init({\n          title: title,\n          onUpdate: inst.onUpdate.bind(inst),\n          filterStore: _storage_plantFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"],\n          tablesStore: _storage_plantTablesStore__WEBPACK_IMPORTED_MODULE_5__[\"default\"].storageData,\n          filterComponent: _filterPlants__WEBPACK_IMPORTED_MODULE_4__[\"default\"]\n        });\n        gridViewPlants.el.querySelector('.left').appendChild(sideMenu.el);\n        var buttonShowMenu = _parts_buttonShowMenu__WEBPACK_IMPORTED_MODULE_9__[\"default\"].init({\n          searchText: 'Search Plants'\n        });\n        inst.el.querySelector('.filter-container').appendChild(buttonShowMenu.el);\n      });\n      return inst;\n    }\n  };\n  Main.init();\n})();\n\n//# sourceURL=webpack:///./src/js/app/searchPlants/mainPlants.js?");
...
eval("module.exports = __webpack_require__(/*! C:\\xampp\\xampp\\htdocs\\1pix_app\\src\\src\\js\\app\\searchPlants\\mainPlants.js */\"./src/js/app/searchPlants/mainPlants.js\");\n\n\n//# sourceURL=webpack:///multi_./src/js/app/searchPlants/mainPlants.js?");

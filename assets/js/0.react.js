...
var _treeTables = __webpack_require__(958);
...
var _tree_fields = __webpack_require__(959);
...
var EditTree = function (_Component) {
    ...
    _createClass(EditTree, [{
        ...
        value: function onSecHeadingClick() {
            //get the current highlighted text
            var selObj = window.getSelection();
            var selectedText = selObj.toString();
            (0, _stringUtils.replaceSelectedText)('<h2>' + selectedText + '</h2>');

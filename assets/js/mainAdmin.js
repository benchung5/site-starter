...
/*!****************************************!*\
  !*** ./src/js/app/actions/products.js ***!
  \****************************************/
/*! exports provided: getProducts, addProduct, fetchProductTables */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../component */ \"./src/js/app/component.js\");\n/* harmony import */ var _parts_fieldInput__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../parts/fieldInput */ \"./src/js/app/admin/parts/fieldInput.js\");\n/* harmony import */ var _parts_fieldDropdownSelect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../parts/fieldDropdownSelect */ \"./src/js/app/admin/parts/fieldDropdownSelect.js\");\n/* harmony import */ var _parts_fieldMultiSelect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../parts/fieldMultiSelect */ \"./src/js/app/admin/parts/fieldMultiSelect.js\");\n/* harmony import */ var _parts_fieldTextarea__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../parts/fieldTextarea */ \"./src/js/app/admin/parts/fieldTextarea.js\");\n/* harmony import */ var _actions_products__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../actions/products */ \"./src/js/app/actions/products.js\");\n/* harmony import */ var _storage_productTablesStore__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../storage/productTablesStore */ \"./src/js/app/storage/productTablesStore.js\");\n/* harmony import */ var _storage_appStateStore__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../storage/appStateStore */ \"./src/js/app/storage/appStateStore.js\");\n/* harmony import */ var _productFields__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./productFields */ \"./src/js/app/admin/products/productFields.js\");\n/* harmony import */ var _lib_formUtils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../lib/formUtils */ \"./src/js/app/lib/formUtils.js\");\n/* harmony import */ var _parts_updateMessage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../parts/updateMessage */ \"./src/js/app/admin/parts/updateMessage.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nvar ProductAdd = {\r\n\tsubmitForm: function(e) {\r\n\t\t// prevent form from refreshing the page\r\n\t\te.preventDefault();\r\n\t\tlet formData = new FormData(e.target);\r\n\r\n\t\t//delete any empty fields in formData\r\n\t\tArray.from(formData).map((item) => {\r\n\t\t\tif (item[1] == '') {\r\n\t\t\t\tformData.delete(item[0]);\r\n\t\t\t}\r\n\t\t});\r\n\r\n\t\t// //use this to log out formdata values\r\n\t\t// console.log(Array.from(formData));\r\n\r\n\t\t//handle field errors\r\n\t\tlet hasErrors = Object(_lib_formUtils__WEBPACK_IMPORTED_MODULE_9__[\"checkFieldErrors\"])(e.target, _productFields__WEBPACK_IMPORTED_MODULE_8__[\"default\"]);\r\n\r\n\t\tif(hasErrors) {\r\n\t\t\tthis.updateMessage.renderError(`<span>please fill in all required fields</span>`);\r\n\t\t} else {\r\n\t\t\t//form no longer touched\r\n\t\t\t_storage_appStateStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"].setData({ formTouched: false });\r\n\r\n\t\t\t// call action to submit edited\r\n\t\t\tObject(_actions_products__WEBPACK_IMPORTED_MODULE_5__[\"addProduct\"])(formData, this.renderUpdated.bind(this));\r\n\r\n\t\t\tthis.updateMessage.clear();\r\n\t\t}\r\n\t},\r\n\tonInputChange: function() {\r\n\t\tthis.updateMessage.clear();\r\n\t},\r\n\trenderUpdated: function(response) {\r\n\t\tthis.updateMessage.clear();\r\n\t\tif(response.error) {\r\n\t\t\tthis.updateMessage.renderError(`<span>Error: ${response.error}</span>`);\r\n\t\t} else {\r\n\t\t\tthis.updateMessage.renderSuccess(`Product id: ${response.id}<br/>successfully added.`);\r\n\r\n\t\t}\r\n\t},\r\n\tbuild: function() {\r\n\t\t//first clear the form fields\r\n\t\tthis.formFields.innerHTML = '';\r\n\t\tthis.updateMessage.clear();\r\n\r\n\t\t//get product table data\r\n\t\tObject(_actions_products__WEBPACK_IMPORTED_MODULE_5__[\"fetchProductTables\"])((productTables) => {\r\n\t\t\t//use productTablesStore because some values exist there statically and not in the productTables\r\n\t\t\tconsole.log(productTables);\r\n\t\t\t_storage_productTablesStore__WEBPACK_IMPORTED_MODULE_6__[\"default\"].setData(productTables);\r\n\r\n\t\t\t//create the fields\r\n\t\t\t_productFields__WEBPACK_IMPORTED_MODULE_8__[\"default\"].map((item) => {\r\n\t\t\t\tif(item.type === 'input') {\r\n\t\t\t\t\tlet input = _parts_fieldInput__WEBPACK_IMPORTED_MODULE_1__[\"default\"].init({\r\n\t\t\t\t\t\tname: item.name,\r\n\t\t\t\t\t\tlabel: item.label,\r\n\t\t\t\t\t\terror: item.error,\r\n\t\t\t\t\t\tcondition: item.condition\r\n\t\t\t\t\t});\r\n\t\t\t\t\tthis.formFields.appendChild(input.el);\r\n\t\t\t\t}\r\n\t\t\t\tif(item.type === 'dropdownSelect') {\r\n\t\t\t\t\t// console.log(productTablesStore.storageData[item.name]);\r\n\t\t\t\t\tlet dropdownSelect = _parts_fieldDropdownSelect__WEBPACK_IMPORTED_MODULE_2__[\"default\"].init({\r\n\t\t\t\t\t\tname: item.name,\r\n\t\t\t\t\t\tlabel: item.label,\r\n\t\t\t\t\t\terror: item.error,\r\n\t\t\t\t\t\tcondition: item.condition,\r\n\t\t\t\t\t\tselectItems: _storage_productTablesStore__WEBPACK_IMPORTED_MODULE_6__[\"default\"].storageData[item.name]\r\n\t\t\t\t\t});\r\n\t\t\t\t\tthis.formFields.appendChild(dropdownSelect.el);\r\n\t\t\t\t}\r\n\t\t\t\tif(item.type === 'multiSelect') {\r\n\t\t\t\t\tlet multiSelect = _parts_fieldMultiSelect__WEBPACK_IMPORTED_MODULE_3__[\"default\"].init({\r\n\t\t\t\t\t\tname: item.name,\r\n\t\t\t\t\t\tlabel: item.label,\r\n\t\t\t\t\t\terror: item.error,\r\n\t\t\t\t\t\tcondition: item.condition,\r\n\t\t\t\t\t\tselectItems: _storage_productTablesStore__WEBPACK_IMPORTED_MODULE_6__[\"default\"].storageData[item.name]\r\n\t\t\t\t\t});\r\n\t\t\t\t\tthis.formFields.appendChild(multiSelect.el);\r\n\t\t\t\t}\r\n\t\t\t\tif(item.type === 'textarea') {\r\n\t\t\t\t\tlet textarea = _parts_fieldTextarea__WEBPACK_IMPORTED_MODULE_4__[\"default\"].init({\r\n\t\t\t\t\t\tname: item.name,\r\n\t\t\t\t\t\tlabel: item.label,\r\n\t\t\t\t\t\terror: item.error,\r\n\t\t\t\t\t\tcondition: item.condition,\r\n\t\t\t\t\t});\r\n\t\t\t\t\tthis.formFields.appendChild(textarea.el);\r\n\t\t\t\t}\r\n\t\t\t});\r\n\t\t});\r\n\t},\r\n\tinit: function() {\r\n\t\tvar proto = Object.assign({}, this, _component__WEBPACK_IMPORTED_MODULE_0__[\"default\"])\r\n\t\tvar inst = Object.create(proto);\r\n\t\t// assign the instance constructor to the prototype so 'this' refers to the instance\r\n\t\tproto.constructor = inst;\r\n\r\n\t\t//call initialize on Component first\r\n\t\tinst.initialize({ el: \r\n\t\t`<div class=\"modal-window\">\r\n        <h3>Add Product</h3>\r\n        <form>\r\n          <div id=\"form-fields\">\r\n          </div>\r\n          <button action=\"submit\" class=\"btn btn-primary\">Submit</button>\r\n        </form>\r\n    </div>\r\n    `\r\n\t\t});\r\n\r\n\t\t//build\r\n\t\tinst.updateMessage = _parts_updateMessage__WEBPACK_IMPORTED_MODULE_10__[\"default\"].init({});\r\n\t\tconst mainWindow = inst.el.querySelector('.main-window');\r\n\t\tinst.formFields = inst.el.querySelector('#form-fields');\r\n\t\tinst.form = inst.el.querySelector('form');\r\n\t\tinst.form.addEventListener('submit', inst.submitForm.bind(inst));\r\n\t\tinst.formFields.addEventListener('focus', () => { _storage_appStateStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"].setData({ formTouched: true }) }, true);\r\n\t\tinst.form.after(inst.updateMessage.el);\r\n\r\n\t\tinst.build();\r\n\r\n\t\treturn inst;\r\n\t}\r\n}\r\n\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (ProductAdd);\n\n//# sourceURL=webpack:///./src/js/app/admin/products/productAdd.js?");

...
/***/ "./src/js/app/parts/paginationArticles.js":
/*!************************************************!*\
  !*** ./src/js/app/parts/paginationArticles.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../component */ \"./src/js/app/component.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config */ \"./src/js/app/config.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_config__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../storage/articleFilterStore */ \"./src/js/app/storage/articleFilterStore.js\");\n/* harmony import */ var _storage_articleListStore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../storage/articleListStore */ \"./src/js/app/storage/articleListStore.js\");\n/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../lib/utils */ \"./src/js/app/lib/utils.js\");\n/* harmony import */ var _actions_articles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../actions/articles */ \"./src/js/app/actions/articles.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nvar PaginationArticles = {\r\n\tupdateOffset: function(newOffset) {\r\n\t\t_storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].setData({ offset: newOffset });\r\n\t\tObject(_lib_utils__WEBPACK_IMPORTED_MODULE_4__[\"setUrlParams\"])('offset', newOffset);\r\n\t\tthis.update();\r\n\t},\r\n\tback: function() {\r\n\t\tif(_storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].storageData.offset === 0 ) { \r\n\t\t\treturn; \r\n\t\t}\r\n\t\tlet newOffset = _storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].storageData.offset - _config__WEBPACK_IMPORTED_MODULE_1__[\"globals\"].ADMIN_ENTRIES_PER_PAGE;\r\n\t\tthis.updateOffset(newOffset);\r\n\t},\r\n\tadvance: function() {\r\n\r\n\t\tif ((_storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].storageData.offset + _config__WEBPACK_IMPORTED_MODULE_1__[\"globals\"].ADMIN_ENTRIES_PER_PAGE) >= _storage_articleListStore__WEBPACK_IMPORTED_MODULE_3__[\"default\"].storageData.count) { \r\n\t\t\treturn; \r\n\t\t}\r\n\t\tlet newOffset = _storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].storageData.offset + _config__WEBPACK_IMPORTED_MODULE_1__[\"globals\"].ADMIN_ENTRIES_PER_PAGE;\r\n\t\tthis.updateOffset(newOffset);\r\n\t},\r\n\tupdate: function() {\r\n\t\t//search articles\r\n\t\tObject(_actions_articles__WEBPACK_IMPORTED_MODULE_5__[\"searchArticles\"])(_storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].storageData, (apiData) => {\r\n\t\t\t_storage_articleListStore__WEBPACK_IMPORTED_MODULE_3__[\"default\"].setData(apiData);\r\n\r\n\t\t\t//prev\r\n\t\t\tif(_storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].storageData.offset === 0) {\r\n\t\t\t\tObject(_lib_utils__WEBPACK_IMPORTED_MODULE_4__[\"toggleClass\"])(this.prev, 'disabled');\r\n\t\t\t}\r\n\t\t\t//next\r\n\t\t\tconst end = ((_storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].storageData.offset + _config__WEBPACK_IMPORTED_MODULE_1__[\"globals\"].ADMIN_ENTRIES_PER_PAGE) >= _storage_articleListStore__WEBPACK_IMPORTED_MODULE_3__[\"default\"].storageData.count) ? true : false;\r\n\t\t\tif(end) {\r\n\t\t\t\tObject(_lib_utils__WEBPACK_IMPORTED_MODULE_4__[\"toggleClass\"])(this.next, 'disabled');\r\n\t\t\t}\r\n\t\t\t//page\r\n\t\t\tthis.page.innerHTML = _storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_2__[\"default\"].storageData.offset / _config__WEBPACK_IMPORTED_MODULE_1__[\"globals\"].ADMIN_ENTRIES_PER_PAGE + 1;\r\n\t\t\t//count\r\n\t\t\tthis.count.innerHTML = _storage_articleListStore__WEBPACK_IMPORTED_MODULE_3__[\"default\"].storageData.count;\r\n\t\t});\r\n\t},\r\n\tinit: function() {\r\n\t\tvar proto = Object.assign({}, this, _component__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\r\n\t\tvar inst = Object.create(proto);\r\n\t\t// assign the instance constructor to the prototype so 'this' refers to the instance\r\n\t\tproto.constructor = inst;\r\n\r\n\r\n\t\t//call initialize on Component first\r\n\t\tinst.initialize({\r\n\t\t\tel: \r\n\t\t\t `<div class=\"paginate-wrapper\">\r\n\t\t\t   <div class=\"paginate\" role=\"navigation\" aria-label=\"Pagination\">\r\n\t\t\t      <div class=\"paginate-previous\">\r\n\t\t\t         <a aria-label=\"Previous page\">\r\n\t\t\t         Previous\r\n\t\t\t         </a>\r\n\t\t\t      </div>\r\n\t\t\t      <div>Page <span id=\"page\"></span></div>\r\n\t\t\t      <div class=\"paginate-next\">\r\n\t\t\t         <a aria-label=\"Next page\">\r\n\t\t\t         Next\r\n\t\t\t         </a>\r\n\t\t\t      </div>\r\n\t\t\t   </div>\r\n\t\t\t   <div class=\"records-count\">(<span id=\"count\"></span> records total)</div>\r\n\t\t\t</div>`\r\n\t\t});\r\n\r\n\t\tinst.prev = inst.el.querySelector('.paginate-previous');\r\n\t\tinst.prev.firstElementChild.addEventListener('click', inst.back.bind(inst), false);\r\n\r\n\t\tinst.next = inst.el.querySelector('.paginate-next')\r\n\t\tinst.next.firstElementChild.addEventListener('click', inst.advance.bind(inst), false);\r\n\t\tinst.page = inst.el.querySelector('#page');\r\n\t\tinst.count = inst.el.querySelector('#count');\r\n\r\n\t\t// get offset from url\r\n\t\tconst offset = Object(_lib_utils__WEBPACK_IMPORTED_MODULE_4__[\"getUrlParams\"])('offset');\r\n\t\tif (offset) {\r\n\t\t  inst.updateOffset(offset[0]);\r\n\t\t} else {\r\n\t\t\tinst.update();\r\n\t\t}\r\n\r\n\t\treturn inst;\r\n\t}\r\n}\r\n\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (PaginationArticles);\n\n//# sourceURL=webpack:///./src/js/app/parts/paginationArticles.js?");
...
eval("module.exports = __webpack_require__(/*! C:\\xampp\\htdocs\\1pix_app\\src\\src\\js\\app\\searchArticles\\mainArticles.js */\"./src/js/app/searchArticles/mainArticles.js\");\n\n\n//# sourceURL=webpack:///multi_./src/js/app/searchArticles/mainArticles.js?");

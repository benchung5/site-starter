...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../component */ \"./src/js/app/component.js\");\n/* harmony import */ var _gridViewArticles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gridViewArticles */ \"./src/js/app/searchArticles/gridViewArticles.js\");\n/* harmony import */ var _parts_sideMenuMobile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../parts/sideMenuMobile */ \"./src/js/app/parts/sideMenuMobile.js\");\n/* harmony import */ var _filterArticles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filterArticles */ \"./src/js/app/searchArticles/filterArticles.js\");\n/* harmony import */ var _storage_appStateStore__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../storage/appStateStore */ \"./src/js/app/storage/appStateStore.js\");\n/* harmony import */ var _storage_articleTablesStore__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../storage/articleTablesStore */ \"./src/js/app/storage/articleTablesStore.js\");\n/* harmony import */ var _storage_articleListStore__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../storage/articleListStore */ \"./src/js/app/storage/articleListStore.js\");\n/* harmony import */ var _storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../storage/articleFilterStore */ \"./src/js/app/storage/articleFilterStore.js\");\n/* harmony import */ var _parts_buttonShowMenu__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../parts/buttonShowMenu */ \"./src/js/app/parts/buttonShowMenu.js\");\n/* harmony import */ var _actions_articles__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../actions/articles */ \"./src/js/app/actions/articles.js\");\n\n\n\n\n\n\n\n\n\n\n(function () {\n  var MainArticles = {\n    onUpdate: function onUpdate(filterData) {\n      if (this.gridViewArticles && this.gridViewArticles.loader) {\n        this.gridViewArticles.loader.isLoading(true);\n      }\n      //search articles\n      Object(_actions_articles__WEBPACK_IMPORTED_MODULE_9__[\"searchArticles\"])(filterData || _storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"].storageData, function (apiData) {\n        _storage_articleListStore__WEBPACK_IMPORTED_MODULE_6__[\"default\"].setData(apiData);\n      });\n    },\n    init: function init() {\n      var proto = Object.assign({}, this, _component__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n      var inst = Object.create(proto);\n      // assign the instance constructor to the prototype so 'this' refers to the instance\n      proto.constructor = inst;\n\n      //init storage\n      _storage_appStateStore__WEBPACK_IMPORTED_MODULE_4__[\"default\"].init();\n      _storage_articleListStore__WEBPACK_IMPORTED_MODULE_6__[\"default\"].init();\n      _storage_articleTablesStore__WEBPACK_IMPORTED_MODULE_5__[\"default\"].init();\n      _storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"].init();\n      //only return articles in production mode for searchArticles\n      _storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"].setData({\n        mode: 2\n      });\n      var appContainer = document.querySelector('.articles-container');\n      var pagePlaceholder = document.createElement('div');\n      pagePlaceholder.className = 'page-loading-placeholder page-loading-placeholder--articles';\n      pagePlaceholder.innerHTML = \"\\n\\t      \\t\\t<div class=\\\"row grid-view-inner\\\">\\n\\t      \\t\\t\\t<div class=\\\"left\\\"></div>\\n\\t      \\t\\t\\t<div class=\\\"right\\\">\\n\\t      \\t\\t\\t\\t<div class=\\\"articles-container page-placeholder-articles\\\">\\n\\t      \\t\\t\\t\\t\\t\".concat(Array.from({\n        length: 5\n      }).map(function () {\n        return \"\\n\\t      \\t\\t\\t\\t\\t\\t<div class=\\\"article-row placeholder-card\\\">\\n\\t      \\t\\t\\t\\t\\t\\t\\t<div class=\\\"inner\\\">\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"image\\\">\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"placeholder-image skeleton\\\"></div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"info\\\">\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"info-body\\\">\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"placeholder-line skeleton\\\"></div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"placeholder-line skeleton\\\"></div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\\"placeholder-line short skeleton\\\"></div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t\\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t\\t\\t\";\n      }).join(''), \"\\n\\t      \\t\\t\\t\\t</div>\\n\\t      \\t\\t\\t</div>\\n\\t      \\t\\t</div>\\n\\t      \\t\");\n      if (appContainer) {\n        appContainer.appendChild(pagePlaceholder);\n      }\n\n      //get the filter settings from the url\n      Object(_actions_articles__WEBPACK_IMPORTED_MODULE_9__[\"updateFilterFromUrl\"])(function () {\n        //call initialize on Component first\n        inst.initialize({\n          container: document.querySelector('.articles-container'),\n          el: \"<div class=\\\"main-container\\\"}>\\n\\t      \\t\\t          <div class=\\\"row\\\">\\n\\t      \\t\\t           <div class=\\\"filter-container\\\">\\n\\t      \\t\\t           </div>\\n\\t      \\t\\t          </div>\\n\\t      \\t\\t        </div>\"\n        });\n        if (pagePlaceholder && pagePlaceholder.parentNode) {\n          pagePlaceholder.parentNode.removeChild(pagePlaceholder);\n        }\n        var sideMenuMobile = _parts_sideMenuMobile__WEBPACK_IMPORTED_MODULE_2__[\"default\"].init({\n          title: 'Search Articles',\n          onUpdate: inst.onUpdate.bind(inst),\n          filterStore: _storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"],\n          tablesStore: _storage_articleTablesStore__WEBPACK_IMPORTED_MODULE_5__[\"default\"].storageData,\n          filterComponent: _filterArticles__WEBPACK_IMPORTED_MODULE_3__[\"default\"]\n        });\n        inst.el.appendChild(sideMenuMobile.el);\n        var gridViewArticles = _gridViewArticles__WEBPACK_IMPORTED_MODULE_1__[\"default\"].init({\n          filterStore: _storage_articleFilterStore__WEBPACK_IMPORTED_MODULE_7__[\"default\"],\n          listStore: _storage_articleListStore__WEBPACK_IMPORTED_MODULE_6__[\"default\"],\n          onUpdate: inst.onUpdate.bind(inst),\n          tablesStore: _storage_articleTablesStore__WEBPACK_IMPORTED_MODULE_5__[\"default\"].storageData,\n          filterComponent: _filterArticles__WEBPACK_IMPORTED_MODULE_3__[\"default\"]\n        });\n        inst.el.appendChild(gridViewArticles.el);\n        inst.gridViewArticles = gridViewArticles;\n        var buttonShowMenu = _parts_buttonShowMenu__WEBPACK_IMPORTED_MODULE_8__[\"default\"].init();\n        inst.el.querySelector('.filter-container').appendChild(buttonShowMenu.el);\n      });\n      return inst;\n    }\n  };\n  MainArticles.init();\n})();\n\n//# sourceURL=webpack:///./src/js/app/searchArticles/mainArticles.js?");
...
eval("module.exports = __webpack_require__(/*! C:\\xampp\\xampp\\htdocs\\1pix_app\\src\\src\\js\\app\\searchArticles\\mainArticles.js */\"./src/js/app/searchArticles/mainArticles.js\");\n\n\n//# sourceURL=webpack:///multi_./src/js/app/searchArticles/mainArticles.js?");

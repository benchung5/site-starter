...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../component */ \"./src/js/app/component.js\");\n/* harmony import */ var _button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./button */ \"./src/js/app/parts/button.js\");\n\n\nvar ButtonList = {\n  onItemClick: function onItemClick(e) {\n    var _this = this;\n    e.preventDefault();\n    var id = e.target.getAttribute('data-id');\n    var modifiedData = this.buttonData.map(function (item, index) {\n      //set current active to the opposite of what it was (toggle);\n      if (item.id == id) {\n        _this.updateButtonState(id, !item.active);\n        return Object.assign(item, {\n          active: !item.active\n        });\n      } else {\n        return item;\n      }\n    });\n    //send callback\n    this.updateData(modifiedData);\n  },\n  updateButtonState: function updateButtonState(id, isActive) {\n    // update the button state\n    var el = this.el.querySelector(\"[data-id=\\\"\".concat(id, \"\\\"]\"));\n    el.dataset.isActive = isActive;\n  },\n  buildButtons: function buildButtons() {\n    var _this2 = this;\n    this.buttonData.map(function (item, index) {\n      var children = _this2.createEl(\"\\n\\t\\t\\t\\t\\t<div>\\n\\t\\t\\t\\t    \\t<i class=\\\"fas fa-\".concat(item.icon, \"\\\"></i>\\n\\t\\t\\t\\t    \\t<div class='check'></div>\\n\\t\\t\\t\\t\\t    <span data-id=\\\"\").concat(item.id, \"\\\" class=\\\"name\\\">\").concat(item.name, \"</span>\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\"));\n      var button = _button__WEBPACK_IMPORTED_MODULE_1__[\"default\"].init({\n        className: \"\".concat(_this2.classPropButton, \" \").concat(item.slug),\n        style: \"height: \".concat(_this2.buttonHeight, \"px\"),\n        isActive: item.active || _this2.allActive,\n        id: item.id,\n        name: item.name,\n        onClick: _this2.onItemClick.bind(_this2),\n        children: children\n      });\n      var wrapper = _this2.createEl(\"<div  class=\\\"\".concat(_this2.wrapperClass, \"\\\"></div>\"));\n      wrapper.appendChild(button.el);\n      _this2.el.appendChild(wrapper);\n      _this2.updateButtonState(item.id, item.active);\n\n      // // if url contains selected categories, just select those\n      // let selectedCategories = getUrlParams('categories');\n      // let isActive = true;\n      //          if (selectedCategories) {\n      //              isActive = false;\n      //              if ((selectedCategories.length > 0) && (selectedCategories.indexOf(item.slug) > -1)) {\n      //                  isActive = true;\n      //              }\n      //              this.updateButtonState(item.id, isActive);\n      //          }\n      // return Object.assign(item, { active: isActive });\n    });\n\n    // console.log(modifiedData);\n\n    // //send initial callback\n    // this.updateData(modifiedData);\n  },\n  init: function init(options) {\n    var proto = Object.assign({}, this, _component__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n    var inst = Object.create(proto);\n    // assign the instance constructor to the prototype so 'this' refers to the instance\n    proto.constructor = inst;\n    inst.buttonData = options.buttonData;\n    inst.wrapperClass = options.wrapperClass;\n    inst.classPropButton = options.classPropButton;\n    inst.buttonHeight = options.buttonHeight;\n    inst.updateData = options.updateData;\n    inst.allActive = options.allActive;\n\n    //call initialize on Component first\n    inst.initialize({\n      el: \"<div class=\\\"button-list \".concat(options.className, \"\\\"></div>\")\n    });\n    inst.buildButtons();\n    return inst;\n  }\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (ButtonList);\n\n//# sourceURL=webpack:///./src/js/app/parts/buttonList.js?");

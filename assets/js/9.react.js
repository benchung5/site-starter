...
/***/ "./src/js/react-app/actions/users/index.js":
/*!*************************************************!*\
  !*** ./src/js/react-app/actions/users/index.js ***!
  \*************************************************/
...
function fetchUsers() {
  return function (dispatch) {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("".concat(SERVER_URL, "/users/all")).then(function (response) {
      dispatch({
...
function deleteUser(_ref) {
  ...
  return function (dispatch) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("".concat(SERVER_URL, "/users/delete"), {
      email: email
    }).then(function (response) {
      if (response.data.error) {//dispatch(deleteUserError(`there was an error deleting the user: ${response.data.error}`));
      } else {
        dispatch(fetchUsers());
      }
    }).catch(function (err) {
...
/***/ "./src/js/react-app/components/admin/users/users_list.js":
/*!***************************************************************!*\
  !*** ./src/js/react-app/components/admin/users/users_list.js ***!
  \***************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _actions_users__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../actions/users */ "./src/js/react-app/actions/users/index.js");
/* harmony import */ var _auth_require_auth__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../auth/require_auth */ "./src/js/react-app/components/admin/auth/require_auth.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Component) {
  ...
  _createClass(UsersIndex, [{
    ...
    value: function renderUsers() {
      ...
      return this.props.users.map(function (user) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          ...
          key: user.email
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, user.email), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          href: "#",
          "data-email": user.email,
          onClick: _this.onDeleteUserClick.bind(_this)
        }, "Delete"));
      });
    }
  }, {
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Users"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_auth_require_auth__WEBPACK_IMPORTED_MODULE_4__["default"])(Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps, _actions_users__WEBPACK_IMPORTED_MODULE_3__)(UsersIndex)));

...
var _auth = __webpack_require__(953);
...
var Signin = function (_Component) {
    ...
    _createClass(Signin, [{
        ...
        key: 'onCaptchaChange',
        value: function onCaptchaChange(value) {
...
var _history = __webpack_require__(345);
...
function signinUser(_ref) {
  ...
  return function (dispatch) {
    ...
    _axios2.default.post(SERVER_URL + '/users/sign_in', { email: email, password: password }, POST_CONFIG).then(function (response) {
      // If request is good...

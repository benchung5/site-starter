...
class Trees extends Controller 
{
	...
	public function search()
	{
		...
		$opts = [
			...
			'tastes' => isset($data['tastes']) ? $data['tastes'] : null,
			'organ_systems' => isset($data['organ_systems']) ? $data['organ_systems'] : null,
			'thermal_nature' => isset($data['thermal_nature']) ? $data['thermal_nature'] : null,
			'moisture' => isset($data['moisture']) ? $data['moisture'] : null,
			'parts_used' => isset($data['parts_used']) ? $data['parts_used'] : null,
			'preparations' => isset($data['preparations']) ? $data['preparations'] : null,
			'organs_and_tissue' => isset($data['organs_and_tissue']) ? $data['organs_and_tissue'] : null,
